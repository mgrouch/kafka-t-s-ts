...
import com.example.txcache.app.domain.*; import com.example.txcache.core.BatchProcessor;
import com.fasterxml.jackson.databind.ObjectMapper; import com.fasterxml.jackson.datatype.jsr310.JavaTimeModule;
import org.springframework.context.ApplicationContextInitializer; import org.springframework.context.support.GenericApplicationContext;
public final class TxCacheInitializer implements ApplicationContextInitializer<GenericApplicationContext>{
  public void initialize(GenericApplicationContext ctx){
    ...
    ctx.registerBean(ObjectMapper.class,()->{var m=new ObjectMapper();m.registerModule(new JavaTimeModule());return m;});
